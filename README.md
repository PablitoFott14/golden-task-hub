...
| **Pre-Submit** | The 28-check gate in seven sections, with progress, a jump nav and `Submit & reset` in a sticky sidebar. Ticks are kept in the browser, and the printable PDF is one click away. |
...
| <https://qc-spec-mt-rubrics.vercel.app/> | The QC Spec tab, generated by [`scripts/gen_spec.py`](scripts/gen_spec.py) |
